...
class Widget_Rangers_Info_Club extends WP_Widget {
    
    public function __construct() {
        $widget_args = [
            'classname' => 'widget_rangers_info_club',
            'description' => __('Our Club Info Sidebar'),
            'customize_selective_refresh' => true,
        ];

        parent::__construct('widget_rangers_info_club', __('Club Info Widget'), $widget_args);
        $this->alt_option_name = 'widget_rangers_info_club';
    }
...
register_widget( 'widget_rangers_info_club');